...
from src.schemas import InfoOnlineCourseInDB
            ...
            for row in rows: 
                ...
                if(len(cols) > 0):
                    ...
                    if(text_col_0 == '№'):
                        ...
                        course = InfoOnlineCourseInDB(name=name, date_start=date, deadline=None, university=university, info=info).model_dump(by_alias=True, exclude=["id"])
