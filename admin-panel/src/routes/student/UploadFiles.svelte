...
<div class="overflow-hidden lg:flex">
    <div class="relative h-full w-full overflow-y-auto lg:ml-64 pt-[70px]">
        ...
        >
            <div
                class="grid grid-cols-1 space-y-2 dark:bg-gray-800 xl:grid-cols-3 xl:gap-3.5"
            >
            ...
            <div class="space-y-2 mb-6">
                ...
                >
                    <Heading
                        tag="h3"
                        class="w-100 text-xl font-semibold text-gray-900 dark:text-gray-100 sm:text-s"
                        >Студенты</Heading
                    >
                    <A
                        class="font-medium hover:underline text-sm"
                        href={server_url + "/parser/upload/student/example"}
                        >Скачать пример</A
                    >
                </div>
                <Fileupload
            ...
            <div class="space-y-2 mb-6">
                ...
                >
                    <Heading
                        tag="h3"
                        class="w-100 text-xl font-semibold text-gray-900 dark:text-gray-100 sm:text-l"
                        >Модеус</Heading
                    >
                    <A
                        class="font-medium hover:underline text-sm"
                        href={server_url +
                            "/parser/upload/choice_in_modeus/example"}
                        >Скачать пример</A
                    >
                </div>
                <Fileupload
            ...
            <div class="space-y-2 mb-6">
                ...
                >
                    ...
                    <A
                        class="font-medium hover:underline text-sm"
                        href={server_url +
                            "/parser/upload/report_online_course/example"}
                        >Скачать пример</A
                    >
                    <A
                        class="font-medium hover:underline text-sm"
            ...
            <div class="flex space-x-2">
                ...
                <select
                    ...
                    bind:this={select}
                    class="w-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                >
                    ...
                    <TableBodyRow role="link" class="contrast">
                        ...
                        <TableBodyCell class="px-8">
                            {#if history_item.type === "site_inf"}
                                ...
                                >
                            {:else}
                                <A class="flex" href={history_item.link}
                                    >Скачать</A
                                >
                            {/if}
                        </TableBodyCell>
