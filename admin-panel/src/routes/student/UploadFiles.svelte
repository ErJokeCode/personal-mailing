<script lang="ts">
    ...
    let courses_success = "";
      ...
      let result = await fetch('http://193.168.3.39:5000/parser/upload/student', {
        method: "POST",
        body: data,
        credentials: "include",
      });
    ...
    async function send_modeus() {
          ...
          let result = await fetch(
              'http://193.168.3.39:5000/parser/upload/choice_in_modeus',
              {
                  method: "POST",
                  body: data,
                  credentials: "include",
      ...
      async function send_courses() {
          ...
          let result = await fetch(
              'http://193.168.3.39:5000/parser/upload/report_online_course',
              {
                  method: "POST",
                  body: data,
                  credentials: "include",
