<script lang="ts">
    ...
    onMount(async () => {
        main_student = (await http.get(`/core/students/${id}`, status)) ?? {};
        student =
            main_student.info !== undefined && main_student.info !== null
                ? main_student.info
                : {};
    });
                ...
                <Breadcrumb class="mb-5">
                    ...
                    <li class="inline-flex items-center">
                        ...
                        <Link
                            ...
                            to="/students/active">Активные студенты</Link
                        >
                    </li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                >
                                    <b>Направление:</b>
                                    {student.group !== undefined
                                        ? student.group.directionCode +
                                          " " +
                                          student.group.nameSpeciality
                                        : "Не известно"}
                                </p>
                            </li>
